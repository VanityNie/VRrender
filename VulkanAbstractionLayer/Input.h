...
#ifndef VULKANABSTRACTIONLAYER_INPUT_H
#define VULKANABSTRACTIONLAYER_INPUT_H
...
public:
    InputProcesser(GLFWwindow* ptr):windowHandle(ptr){}
...
#endif //VULKANABSTRACTIONLAYER_INPUT_H
